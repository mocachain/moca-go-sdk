...
import (
	...
	types "github.com/mocachain/moca-go-sdk/types"
)

// IChallengeClient - Client APIs for operating and querying Moca challenges.
...
//
// Moca will not keep the results of all challenges, only the latest ones will be kept and old ones will be pruned.
//
// - ctx: Context variables for the current API call.
//
...
//
// Moca will only allow the in-turn validator to submit challenge attestations.
//
// - ctx: Context variables for the current API call.
//
...
// ChallengeParams - Get challenge module's parameters of Moca blockchain.
//
// - ctx: Context variables for the current API call.
//
