...
import (
	...
	httplib "github.com/MocaFoundation/moca-common/go/http"
	"github.com/MocaFoundation/moca-go-sdk/types"
)

// IAuthClient - Client APIs for register Moca off chain auth keys and make signatures.
...
// The overall register process could be referred to https://docs.moca.network/.
//
...
//
// - spAddress: The sp operator address, to which this API will register client's EdDSA public key. It can be found via https://docs.moca.network/ .
//
