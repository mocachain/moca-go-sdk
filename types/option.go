...
type CreateStorageProviderOptions struct {
	ReadPrice             math.LegacyDec // ReadPrice defines the storage provider's read price, in amoca wei per charge byte.
	FreeReadQuota         uint64         // FreeReadQuota defines the free read quota of the SP.
	StorePrice            math.LegacyDec // StorePrice defines the store price of the SP, in amoca wei per charge byte.
